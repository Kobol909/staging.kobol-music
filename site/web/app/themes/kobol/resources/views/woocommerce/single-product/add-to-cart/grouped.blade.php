...
<form class="cart grouped_form" action="@php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); @endphp" method="post" enctype='multipart/form-data'>
	...
	@php if ( $quantites_required && $show_add_to_cart_button ) : @endphp

		@php do_action( 'woocommerce_before_add_to_cart_button' ); @endphp

		<button type="submit" class="single_add_to_cart_button button alt">@php echo esc_html( $product->single_add_to_cart_text() ); @endphp</button>
