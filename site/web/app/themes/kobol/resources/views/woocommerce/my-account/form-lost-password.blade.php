...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="user_login">{!! esc_html_e( 'Username or email', 'woocommerce' ); !!}</label>
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="woocommerce-Button button" value="@php esc_attr_e( 'Reset password', 'woocommerce' ); @endphp">@php esc_html_e( 'Reset password', 'woocommerce' ); @endphp</button>
	</p>
