...
<form class="cart" action="@php echo esc_url( $product_url ); @endphp" method="get">
	@php do_action( 'woocommerce_before_add_to_cart_button' ); @endphp

	<button type="submit" class="single_add_to_cart_button button alt">@php echo esc_html( $button_text ); @endphp</button>
